...
export const journeySteps: JourneyStep[] = [
  {
    ...
    title: 'Hello World!',
    description:
      'Started my Computer Science degree, diving into Object-Oriented Programming and core concepts.',
    icon: 'Code',
...
int main() {
  ...
  },
  {
    ...
    description:
      'Started working as a Laboratory Assistant for courses and joined communities.',
    icon: 'Rocket',
...
createWebsite();`,
  ...
  },
  {
    ...
    description:
      "Explored backend systems and cloud architecture. Completed Dicoding's course and earned Backend Expert certification.",
    icon: 'Server',
...
app.listen(3000);`,
  ...
  },
  {
    ...
    description:
      "Graduated with distinction from Bangkit's ML program and earned a TensorFlow Developer certification.",
    icon: 'Brain',
...
model.compile(optimizer='adam')`,
  ...
  },
  {
    ...
    description:
      'Building large-scale microservices at PLN Icon Plus and mentoring students at Bangkit Academy and Dicoding.',
    icon: 'Users',
...
async def get_data():
  ...
  },
  {
    ...
    description:
      'Continuing to learn and grow as a software engineer. Staying updated with industry trends and best practices.',
    icon: 'Rocket',
    code: `
interface Growth {
  scale: 'national';
