import { HiOutlineHome, HiOutlineBriefcase, HiOutlinePencilAlt, HiOutlineUser, HiOutlineChevronDown } from "react-icons/hi"
...
export const navigationTabs = [
  ...
  { id: "more", label: "More", href: "#", logo: <HiOutlineChevronDown className="w-5 h-5" />, isDropdown: true },
]