        ...
        >
          ...
          <div className="relative">
            ...
            <div className="relative p-[1px] bg-gradient-to-r from-blue-500/30 via-purple-500/30 to-pink-500/30 rounded-full">
              {/* Main navbar */}
              <div className="relative bg-gray-100/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-full px-2 py-1.5 shadow-2xl shadow-gray-900/10 dark:shadow-gray-900/30">
