...
>(({ 
  ...
  const shadowIntensityValue = shadowIntensity === 'light' ? '0.15' : 
                              shadowIntensity === 'strong' ? '0.5' : '0.3';
    ...
    >
      ...
      <div 
        ...
        style={{
          ...
          filter: `blur(${shadowIntensity === 'light' ? '8px' : 
                          shadowIntensity === 'strong' ? '16px' : '12px'})`,
        }}
      />
