  ...
  return (
    <motion.div variants={cardVariants}>
      <GradientShadowCard 
        ...
        aria-label={`Featured project: ${project.frontmatter.title}`}
        className="h-full"
      >
        <Link href={`/projects/${project.slug}`} className="block h-full group">
          <div className="bg-card border rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300 h-full flex flex-col">
