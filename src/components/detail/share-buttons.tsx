...
export function ShareButtons({
  ...
  const shareUrls = {
    ...
    instagram: `https://www.instagram.com/create/story/?url=${encodeURIComponent(
      url,
    )}`, // Instagram Stories (opens story creation)
  ...
  return (
    ...
    >
      ...
      <Button
        ...
        className={`transition-colors min-h-[44px] touch-manipulation w-full sm:w-auto cursor-pointer ${
          copied
      ...
      >
        {copied ? (
          <>
            {getIcon('Check', 'size4 mr-1')}
            Copied!
          </>
        ) : (
          <>
            {getIcon('Link', 'size4 mr-1')}
            Copy Link
          </>
        )}
      </Button>
